...
const reducer = function(state = initialState, action) {
    ...
    // using let as a signal that the individualTimerObj's properties is going to be mutated, even if it itself will never be reassigned.
    let _individualTimerObjEl = util.getCurrentObjEl();
    let _currentIndex = util.getCurrentIndex();
